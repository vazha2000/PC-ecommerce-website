...
import MonitorsFiltersResp from './pagesHelpers/MonitorsFiltersResp'
  ...
  return (
    <div>
      ...
      <div className='md:flex gap-5 items-center'>
        <img src={monitor} className="w-[80px]" />
        <p className='font-medium'>Find the Monitor you want and enjoy the quality</p>
      </div>
      </div>
