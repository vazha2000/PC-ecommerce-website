          ...
          <div className='w-auto flex  justify-center mx-10 '>
            <div className=' hidden lg:ml-2 lg:flex lg:flex-col lg:w-1/5 w-full '>
              <div className="relative mb-2  hidden lg:flex flex-col ">
                  ...
                  <p className='px-4'>Price Range: 1$ - 5000$</p>
                  <input 
                    type="range" 
                    min="0" 
                    max="5000" 
              ...
              <div className='lg:flex flex-col hidden'>
                <p className='border-b-gray-400 pb-2 border border-x-0 border-t-0 px-4'>Type of Processor</p>
                <div className='flex'>
                  <input 
                  type="checkbox"
                  className=''
                  ...
                  name="Intel Core i3"
                  />
                  <label className='ml-2'>Intel Core i3</label>
                </div>
                <div className='flex'>
                  <input 
                  type="checkbox"
                  ...
                  />
                  <label className='ml-2'>Intel Core i5</label>
                </div>
                <div className='flex'>
                  <input 
                  type="checkbox"
                  ...
                  />
                  <label className='ml-2'>Intel Core i7</label>
                </div>
                <div className='flex'>
                  <input 
                  type="checkbox"
                  ...
                  />
                  <label className='ml-2'>Intel Core i9</label>
                </div>
              </div>
              <div className='lg:flex flex-col hidden'>
              ...
              <div className='lg:flex flex-col hidden'>
                <p className='border-y-gray-400 py-2 border border-x-0 px-4'>HDD CAPACITY</p>
                <div className='flex'>
                  <input 
                    type="checkbox"
                    className=''
                ...
                <div className='flex'>
                  ...
                  />
                  <label className='ml-2'>4TB</label>
                </div>
                <div className='flex'>
                  <input 
                    type="checkbox"
                  ...
                  />
                  <label className='ml-2'>10TB</label>
                </div>
                <div className='flex'>
                  <input 
                    type="checkbox"
                  ...
                  />
                  <label className='ml-2 text-red-700'>No HDD</label>
                </div>
              </div>
              <div className='lg:flex flex-col hidden'>
            ...
            <div className='lg:w-4/5'>
              <ComputersList priceRange={priceRange} checkbox1={checkbox1} 
